...
| 包名                                                   | 本仓库版本 | npm 最新版                                                     | 描述                                                       |
| ------------------------------------------------------ | ---------- | -------------------------------------------------------------- | ---------------------------------------------------------- |
| [@robot-admin/layout](./packages/layout)               | `3.0.0`    | [![npm](https://img.shields.io/npm/v/@robot-admin/layout)](https://www.npmjs.com/package/@robot-admin/layout) | 6 种布局、设置 Store、纯核心入口与安全扩展能力             |
