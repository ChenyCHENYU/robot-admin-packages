...
| [@robot-admin/request-core](./packages/request-core)   | `0.4.0`    | [![npm](https://img.shields.io/npm/v/@robot-admin/request-core)](https://www.npmjs.com/package/@robot-admin/request-core)   | 实例化 Axios 编排、认证恢复与 Headless CRUD Composables  |
