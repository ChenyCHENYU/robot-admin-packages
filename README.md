...
| [@robot-admin/theme](./packages/theme)                 | `0.6.0`    | [![npm](https://img.shields.io/npm/v/@robot-admin/theme)](https://www.npmjs.com/package/@robot-admin/theme)                 | 语义 Token、Vue/Pinia Store 与 Naive UI 分层适配         |
...
| [@robot-admin/request-core](./packages/request-core)   | `0.6.0`    | [![npm](https://img.shields.io/npm/v/@robot-admin/request-core)](https://www.npmjs.com/package/@robot-admin/request-core)   | 实例化 Axios 编排、认证恢复与函数式 Headless CRUD         |
